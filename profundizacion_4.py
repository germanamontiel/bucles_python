...
for temp in temp_dataloger:
    if (temp > 20.0) and (temp < 25.0):
        temperatura_max = temp
    elif (temp < 15.0) and (temp > 10.0):
        temperatura_min = temp

print("La temperatura maxima actual es de:", temperatura_max, "que es igual a: ", max(temp_dataloger)) 
print("La temperatura minmina actual es de:", temperatura_min, "que es igual a: ", min(temp_dataloger))
...
print("El total de temperatura registrada suma un total de:", temperatura_sumatoria, "que es igual a:", sum(temp_dataloger))

temperatura_len = len(temp_dataloger)
temperatura_promedio = temperatura_sumatoria / temperatura_len

print("El promedio total de temperaturas es de:", temperatura_promedio)
...
elif temperatura_min >= 10 and temperatura_max <= 20:
    print("Estamos en Otoño")
elif temperatura_min <= 10 and temperatura_max <= 14:
