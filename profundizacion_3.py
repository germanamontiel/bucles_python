...
print("El alumno estuvo presente", cantidad_notas, "dias")
#print("El alumno estuvo ausente", cantidad_ausentes, "dias")

for numeros in notas:
    if numeros > 0:
        sumatoria += numeros 
        
print("La suma de notas es igual a: ", sumatoria)
